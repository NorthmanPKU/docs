---
title: "Multi-Agent"
description: "Compose agents into supervisor/specialist patterns using as_tool(), fork(), and parallel task graphs."
---

Motus lets you compose multiple agents into larger workflows. The primary patterns are: wrapping a specialist agent as a tool for a supervisor, forking an agent to create independent conversation branches, and running sub-agents in parallel using the task graph runtime.

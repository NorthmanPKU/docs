...
<Note>
Compaction only triggers at clean turn boundaries to avoid corrupting in-progress tool call sequences. It defers until all tool results from a parallel tool call batch have arrived.
</Note>
